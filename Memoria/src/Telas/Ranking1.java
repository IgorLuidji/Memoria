...
public class Ranking1 extends JFrame {
    ...
    public Ranking1(String nome, int erros){
        super("Ranking Por Tempo");
        img = new ImageIcon(System.getProperty("user.dir")+("\\src\\Telas")+("\\Imagens\\Ranking.png"));
        painel = new Panel();
    ...
    public int[] lerarquivo(){
        ...
        try {
            ...
            FileReader file = new FileReader(System.getProperty("user.dir")+("\\src\\Ranking\\")+("Resultados1.txt"));
    ...
    public String[] lernomes(){
        ...
        try {
            ...
            FileReader file = new FileReader(System.getProperty("user.dir")+("\\src\\Ranking\\")+("Nomes1.txt"));
            BufferedReader buf = new BufferedReader(file);
    ...
    public void EscreverArq(int[] ranking,String[] nomes){
        try {
            ...
            FileWriter Ranking = new FileWriter(System.getProperty("user.dir")+("\\src\\Ranking\\")+("Resultados1.txt"));
            PrintWriter gravarRanking = new PrintWriter(Ranking);
            FileWriter Nomes = new FileWriter(System.getProperty("user.dir")+("\\src\\Ranking\\")+("Nomes1.txt"));
